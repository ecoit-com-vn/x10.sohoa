...
public sealed class ExternalApiKeyProtector : IExternalApiKeyProtector
{
    private readonly byte[] _encryptionKey;

    public ExternalApiKeyProtector(IConfiguration configuration)
    {
        var secret = configuration["ExternalApiKeys:EncryptionKey"]
            ?? configuration["Jwt:Key"]
            ?? throw new InvalidOperationException("External API key encryption secret is not configured.");
