...
public class SubstationController : ControllerBase
{
    ...
    public async Task<IActionResult> Update(Guid id, [FromBody] Infrastructure infrastructure)
    {
        ...
        if (!success)
            return StatusCode(500, new { message = "Không thể cập nhật thông tin trạm biến áp." });
    ...
    public async Task<IActionResult> Delete(Guid id)
    {
        ...
        if (!success)
            return StatusCode(500, new { message = "Không thể xóa trạm biến áp." });

        return Ok(new { message = "Xóa trạm biến áp thành công." });
    }
    ...
    public async Task<IActionResult> Lock(Guid id)
    {
        ...
        if (!success)
            return StatusCode(500, new { message = "Không thể khóa trạm biến áp." });

        return Ok(new { message = "Đã khóa trạm biến áp thành công." });
    }
