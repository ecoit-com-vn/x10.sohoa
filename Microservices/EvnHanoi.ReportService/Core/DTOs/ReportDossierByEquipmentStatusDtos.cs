...
{
    public class DossierByEquipmentStatusFilterDto
    {
        ...
        /// <summary>Id tình trạng thiết bị (CATALOG.Id, CatalogType.Code = EQUIPMENT_STATUS) — multi-select.</summary>
        public List<string>? EquipmentStatusIds { get; set; }
        public int Page { get; set; } = 1;
        public int PageSize { get; set; } = 10;
    }

    /// <summary>Biểu đồ cột ngang — số lượng Hồ sơ/Tài liệu/Trang theo từng loại thiết bị.</summary>
    public class DossierByEquipmentStatusChartStatDto
    {
