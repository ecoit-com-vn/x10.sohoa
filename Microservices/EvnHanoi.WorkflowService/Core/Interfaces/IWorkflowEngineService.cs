...
namespace EvnHanoi.WorkflowService.Core.Interfaces
{
    public interface IWorkflowEngineService
    {
        ...
        Task<WorkflowInstance> MoveWithValidationAsync(string targetEntityId, string nextNodeId, string userId, List<string> userRoles, bool isAdmin, string actionLabel, string? comment = null, string? nextAssigneeUserId = null);
