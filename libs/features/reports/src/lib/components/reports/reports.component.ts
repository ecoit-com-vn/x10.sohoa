...
export class ReportsComponent {
  ...
  reportsList = [
    ...
    {
      name: 'Báo cáo hồ sơ thiết bị theo trạm',
      icon: 'pi pi-map-marker',
      url: '/reports/dossier-by-station',
      permission: 'REPORT_DOSSIER_BY_STATION_VIEW',
      description: 'Xem báo cáo chi tiết và thống kê hồ sơ thiết bị theo từng trạm biến áp.'
    },
    {
