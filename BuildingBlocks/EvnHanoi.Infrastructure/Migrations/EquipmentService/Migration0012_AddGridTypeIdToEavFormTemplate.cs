...
public class Migration0012_AddGridTypeIdToEavFormTemplate : IScript
{
    public string ProvideScript(Func<IDbCommand> dbCommandFactory)
    {
        using (var cmd = dbCommandFactory())
        {
            ...
            // Thêm cột GridTypeId vào bảng EavFormTemplates
            // ORA-01430: column being added already exists in table
            ExecuteNonQuery("ALTER TABLE EavFormTemplates ADD GridTypeId INT NULL", 1430);
        }
