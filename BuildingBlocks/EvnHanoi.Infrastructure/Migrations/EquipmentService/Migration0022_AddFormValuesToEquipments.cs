...
public class Migration0022_AddFormValuesToEquipments : IScript
{
    public string ProvideScript(Func<IDbCommand> dbCommandFactory)
    {
        using (var cmd = dbCommandFactory())
        {
            ...
            // Thêm cột FORM_VALUES kiểu CLOB vào bảng EQUIPMENTS
            // ORA-01430: column being added already exists in table
            ExecuteNonQuery("ALTER TABLE EQUIPMENTS ADD FORM_VALUES CLOB NULL", 1430);
        }
