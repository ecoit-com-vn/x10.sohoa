...
public class Migration0004_AddDescriptionInfoColumn : IScript
{
    public string ProvideScript(Func<IDbCommand> dbCommandFactory)
    {
        using (var cmd = dbCommandFactory())
        {
            ...
            // Add DescriptionInfo column to EavFormTemplates table
            // ORA-01430: column being added already exists in table
            ExecuteDDL("ALTER TABLE EavFormTemplates ADD DescriptionInfo VARCHAR2(1000) NULL", 1430);
        }
